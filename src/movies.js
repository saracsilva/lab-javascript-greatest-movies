...
function scoresAverage(moviesArray) {
  ...
  /*for (let i = 0; i < moviesArray.length; i += 1) {
    if (typeof moviesArray[i].score === "number") {
      scoresMovies.push(moviesArray[i]);
    }
  }*/
  let scoresMovies = moviesArray.filter(
...
/* const numbersScores = moviesArray.map((movie) => movie.score);
  if (numbersScores.length === 0) {
    return 0;
  }
  const totalScore = numbersScores.reduce(
    (previousValue, currentValue) => previousValye + currentValue,
    0
  );
...
/*let scoresMovies = [];
  ...
  for (let i = 0; i < moviesArray.length; i += 1) {
    if (moviesArray[i].score.typeof === "number") {
      console.log(moviesArray[i]);
      scoresMovies = scoresMovies.push(moviesArray[i]);
    }
  }*/
